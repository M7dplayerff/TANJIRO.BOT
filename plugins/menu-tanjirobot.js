...
        'ph': 'قــســم الـاسـتـعـارة'
			...
			if (teks == '【🙀┇قــســم⍅الـريـأكـشـن】') tags = {

        're': 'قــســم الـريـأكـشـن'
			}
