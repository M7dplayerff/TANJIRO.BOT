    ...
    this.sendMessage(id, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'https://l.arzfun.com/Pifbx',
                renderLargerThumbnail: true,
...
let msg = {
    premium: '- *🔱 عــذرا هــذا الـامــر لـلـمـسـتـخـدمـيـن الـبـريـمـيــوم فــقــط*',
    group: '- *🔱 هــذا الـامــر مــتــاح لـلــرومــات فــقــط*',       
    private: '- *🔱 هــذا الـامــر مــتــاح لــلــشــات الــخــاص فــقــط*',       
    botAdmin: '- *🔱 قــم بــرفــع الــبــوت ادمـــن لـتـفـعـيـل ذلــك الـامـــر*',
    admin: '- *🔱 هــذا الــامـــر خــاص بـمـشـرفـيـن الـمـجـمـوعــة فــقــط*',
    restrict: '- *🔱 هــذه الــمــيــزة غــيــر مـفـعـلـة فــي هــذا الــشــات*',
    game: '- *🔱 وضــع الـالــعــاب غــيــر مـفـعـل فــي هــذا الــشــات*',
    rpg: '- *🔱 وضــع الـاعــمــال غــيــر مــفــعــل فــي هــذا الــشــات*',
    rowner: '- *🔱 هــذا الــامــر خـــاص بــلــمــالــكــيــن فــقــط*',
    owner: '- *👑 هــذا الــامــر خـــاص بــلــمــطــور Users فــقــط*',
